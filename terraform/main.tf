...
# Subnet - DEPENDE DE VNET COMENTADO
...
# Network Interface - DEPENDE DE SUBNET Y PUBLIC_IP COMENTADOS
...
# Associate NSG with Subnet - DEPENDE DE SUBNET Y NSG COMENTADOS
resource "azurerm_subnet_network_security_group_association" "nsg_association" {
  subnet_id                 = azurerm_subnet.subnet.id
  network_security_group_id = azurerm_network_security_group.nsg.id
}

# Virtual Machine - DEPENDE DE NIC COMENTADO
